...
<div class="bannerbg-w3l bannerbg-w3l-inner">
    ...
    if (! isset($_SESSION['userId']) || ! isset($_SESSION['userName'])) {
        ...
        ?>
									...
									</a> <a href="<?php $_SERVER['DOCUMENT_ROOT']?>/HomepageError/login/logout.php"> <i class="fas fa-key mr-2"></i>ログアウト
								</a>
				...
				<nav class="navbar navbar-expand-lg navbar-light bg-light">
					<a class="navbar-brand" href="<?php $_SERVER['DOCUMENT_ROOT']?>/HomepageError/index.php">まるまる不動産 </a>
							...
							<li class="nav-item dropdown mx-lg-3"><a
								...
								<div class="dropdown-menu" aria-labelledby="navbarDropdown"
									...
									<a class="dropdown-item scroll" href="#"
										onclick="location.href='/HomepageError/list/newHouse.php'">新築マンション</a> <a
										class="dropdown-item scroll" href="/HomepageError/list/oldHouse.php">中古マンション</a>
									<div class="dropdown-divider"></div>
									<a class="dropdown-item scroll" href="#"
										onclick="location.href='/HomepageError/list/newHouse.php'">新規一戸建て</a> <a
	...
	<div class="banner-w3ltext about-w3bnr">
		<div class="container">
			<h1 class="text-white text-center">
				<a href="<?php $_SERVER['DOCUMENT_ROOT']?>/HomepageError/index.php">トップ</a> / <font id="topMsg"></font>
			</h1>
		</div>
	</div>
	<!-- //banner-text -->
